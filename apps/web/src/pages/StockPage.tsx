...
export default function StockPage() {
  ...
  const { session, isAdmin, canWriteArea } = useAuth();
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            {canWriteArea('estoque') && <Button icon={<Upload className="h-4 w-4" />} onClick={() => setImportOpen(true)}>Importar planilha</Button>}
          </>
        }
      />
